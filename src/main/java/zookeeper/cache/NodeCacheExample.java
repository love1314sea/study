...
//		TestingServer server = new TestingServer();
		...
		try {
//			client = CuratorFrameworkFactory.newClient("192.168.1.129:2181", new ExponentialBackoffRetry(1000, 3));
			client = CuratorFrameworkFactory.newClient("127.0.0.1:2181", new ExponentialBackoffRetry(1000, 3));
//			client = CuratorFrameworkFactory.builder().connectString("127.0.0.1").retryPolicy(new ExponentialBackoffRetry(1000, 3)).build();
			client.start();
//			client.create().withMode(CreateMode.CONTAINER).forPath(PATH);
