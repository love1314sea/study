...
public class _01_UrlClassLoaderTest {
	...
	public static void main(String[] args) throws Exception{
		...
		//必须声明协议; 最后必须加上/
		URL[] urls = new URL[] {new URL("file:/Users/wushang/IdeaProjects/toyprogram/study/src/main/java/类加载器/")};
		...
		File file = new File("/Users/wushang/IdeaProjects/toyprogram/study/src/main/java/类加载器/_01_UrlClassLoaderTest.java");
	}
}
